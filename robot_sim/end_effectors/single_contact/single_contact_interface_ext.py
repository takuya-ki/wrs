...
class SingleContactInterface(object):
    ...
    def __init__(
        ...
        # singlecontact center
        self.singlecontact_center_pos = np.zeros(3)
        self.singlecontact_center_rotmat = np.eye(3)
        # collision detection
        self.cc = None
    ...
    def singlecontact_to_with_dcpose(
            self,
            gl_singlecontact_center_pos,
            gl_singlecontact_center_rotmat):
        """
        ...
        :return:
        """
        eef_root_rotmat = gl_singlecontact_center_rotmat.dot(
            self.singlecontact_center_rotmat.T)
        eef_root_pos = \
            gl_singlecontact_center_pos - eef_root_rotmat.dot(self.singlecontact_center_pos)
        self.fix_to(eef_root_pos, eef_root_rotmat)
        return [gl_singlecontact_center_pos,
                gl_singlecontact_center_rotmat,
                eef_root_pos,
                eef_root_rotmat]

    def singlecontact_to_with_dczy(
            self,
            gl_singlecontact_center_pos,
            gl_singlecontact_center_z,
            gl_singlecontact_center_y):
        """
        ...
        gl_jaw_center_rotmat[:, 2] = \
            rm.unit_vector(gl_singlecontact_center_z)
        gl_jaw_center_rotmat[:, 1] = \
            rm.unit_vector(gl_singlecontact_center_y)
        gl_jaw_center_rotmat[:, 0] = \
            np.cross(gl_jaw_center_rotmat[:3, 1], gl_jaw_center_rotmat[:3, 2])
        return self.singlecontact_to_with_dcpose(
            gl_singlecontact_center_pos, gl_singlecontact_center_z)
